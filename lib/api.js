...
var PushoverAPI = GObject.registerClass(
    class PushoverAPI extends GObject.Object {
        ...
        _init() {
            ...
            this.lg("Loaded Soup version: " + Soup.MAJOR_VERSION + "." + Soup.MINOR_VERSION);
        }
        ...
        poll() {
            if (this.login()) {
                ...
                if (msgs != null) {
                    ...
                    msgs.forEach((msg) => {
                        //bugfix: use msg.id_str iso. msg.id to avoid dealing with 64-bit integers
                        //Many thanks a lot to @jcs and the Pushover team for the PR and fix.
                    ...
                    if (msgs.length > 0 && this.lastID != "" && this.lastID != this.lastDeletedID) {
